...
public class HomeActivity extends  Activity { 
	...
	public void _dialog_title_color (final AlertDialog.Builder _dialog, final String _title, final String _color) {
		_dialog.setTitle(Html.fromHtml("<font color=\"#"+_color+"\">"+_title+"</font>"));
	}
	
	
	public void _dialog_message_color (final AlertDialog.Builder _dialog, final String _msg, final String _color) {
